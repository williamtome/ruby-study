...
def binary_search(arr, number_search, low_index, high_index)
  ...
  binary_search(arr, number_search, middle_index + 1, high_index) if number_search > arr[middle_index]

  binary_search(arr, number_search, low_index, middle_index - 1) if number_search < arr[middle_index]
end
